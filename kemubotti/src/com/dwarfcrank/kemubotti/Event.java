...
public class Event implements Comparable<Event> {
    ...
    /**
     * Compares this Event to another Event. The event name is completely
     * irrelevant to this comparison as the comparison is based entirely on
     * dates.
     *
     * @param t The other Event to compare to.
     * @return < 0 if the event is earlier than t, > 0 if the event is later
     * than t and 0 if it is at the same time as t.
     */
    @Override
